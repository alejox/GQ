<template>
    <b-card>
        ...
        <div class="text-center">
            ...
            <h1 class="mb-5">
                ${{ total != null ? coinFormat(total.total[0].meta.total) : 0 }}
            </h1>
        </div>
        <div class="row pl-4 pr-4">
            ...
            <div class="col-6 mb-2 text-right">
                {{ total != null ? total.success[0].meta.total : 0 }}
            </div>
            <div class="col-6 mb-2">
                Faileds
            </div>
            <div class="col-6 mb-2 text-right">
                {{ total != null ? total.fail[0].meta.total : 0 }}
            </div>
            <div class="col-6 mb-2">
                Pendings
            </div>
            <div class="col-6 mb-2 text-right">
                {{ total != null ? total.pending[0].meta.total : 0 }}
            </div>
        </div>
    </b-card>
</template>
...
export default {
    ...
    methods: {
        ...
        ...mapActions('cart', ['getTotalsAdmin']),
        getData() {
            this.loading = false
